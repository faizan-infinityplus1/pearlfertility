...
<head>
    ...
    <title>2D- ECHO, ECG, USG - Pearl Fertility and IVF</title>
    <!-- -----font awesome---- -->
...
<body>
    ...
    <div class="page-header"> <!-- Page Header -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="heading bold">2D- ECHO, ECG, USG</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">2D- ECHO, ECG, USG</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row  d-flex align-items-start">
                ...
                <div class="col-lg-6 col-md-6 col-12 wow fadeInRight">
                    <img src="_images/balsto-1.jpg" class="img-fluid mt-5 mb-2" alt="">
                </div>
