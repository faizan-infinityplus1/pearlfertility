...
<head>
    ...
    <title>CARDIOLOGY AND MEDICAL EVALUATION - Pearl Fertility and IVF</title>
...
<body>
    ...
    <div class="page-header"> <!-- Page Header -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="heading bold">CARDIOLOGY AND MEDICAL EVALUATION</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">CARDIOLOGY AND MEDICAL EVALUATION</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row  d-flex align-items-start">
                ...
                <div class="col-lg-6 col-md-6 col-12 wow fadeInRight">
                    <img src="_images/third.png" class="img-fluid mt-5 mb-2" alt="">
                </div>
