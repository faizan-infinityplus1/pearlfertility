...
<body>
    ...
    <div class="container-fluid">
      <div class="row">
        <div class="home-slider-one">
          <!--Slider Items Start-->
          <div class="slider-items" style="background-image: url('_images/slide1.png')">
            <div class="container">
                  ...
                  <div class="slider-content">
                    <div class="slider-content-inner">
                      ...
                      <div class="slider-paragraph pb-25 pt-20">
                        <p class="p-head">
                          Experience the empowering medical odyssey of Fertility and IVF Journeys, embracing transformative paths toward parenthood.
                        </p>
                      </div>
                      <!--// Slider Paragraph End-->
                      <div class="main-btn-wrap">
                        <a href="" class="main-btn btn">Make An Appointment</a>
                      </div>
                      <!--// Main Btn Wrap End-->
                    </div>
                  </div>
          ...
          <!--Slider Items Start-->
          <div class="slider-items" style="background-image: url('_images/slide2.png')">
            <div class="container">
              <div class="slider-items-wrap">
                <div class="slider-inner">
                  <div class="slider-content">
                    <div class="slider-content-inner">
                      ...
                      <div class="slider-title">
                        <h1 class="heading-01 h1-head">
                          Blossom Blend:
                          <span class="bold">Fertility's Blossoming Tapestry</span>
                        </h1>
                      </div>
                      <!--// Slider Title End-->
                      ...
                      <div class="slider-paragraph pb-25 pt-20">
                        <p class="p-head">
                          Fertility's Blossoming Tapestry weaves the intertwined beauty of fertility, painting a vibrant journey to parenthood filled with hope and joy.
                        </p>
                      </div>
                      <!--// Slider Paragraph End-->
                      <div class="main-btn-wrap">
          ...
          <!--Slider Items Start-->
          <div class="slider-items" style="background-image: url('_images/slide3.png')">
            <div class="container">
              <div class="slider-items-wrap">
                <div class="slider-inner">
                  <div class="slider-content">
                    <div class="slider-content-inner">
                      ...
                      <div class="slider-title">
                        <h1 class="heading-01 h1-head ">
                          Conceiving Dreams:
                          <span class="bold">Fertility's Pathway To Pregnancy</span>
                        </h1>
                      </div>
                      <!--// Slider Title End-->
                      ...
                      <div class="slider-paragraph pb-25 pt-20">
                        <p class="p-head">
                          Signifies the intricate journey of conception, illustrating the navigation through challenges and triumphs on the way to the joyous destination of parenthood.
                        </p>
                      </div>
                      <!--// Slider Paragraph End-->
                      <div class="main-btn-wrap">
          ...
          <!--Slider Items Start-->
          <div class="slider-items" style="background-image: url('_images/slide4.png')">
            <div class="container">
              <div class="slider-items-wrap">
                <div class="slider-inner">
                  <div class="slider-content">
                    <div class="slider-content-inner">
                      ...
                      <div class="slider-paragraph pb-25 pt-20">
                        <p class="p-head">
                          Fertility's medical journey to pregnancy wellness encompasses targeted interventions for optimal conception and overall well-being.
                        </p>
                      </div>
                      <!--// Slider Paragraph End-->
                      <div class="main-btn-wrap">
  ...
  <div class="container mt-80 ">
    <div class="row  justify-content-center">
      <div class="col-lg-8 wow fadeInLeft " data-wow-delay="1s">
        <div class="heading-block">
          <h2 class="heading font-bold text-lh-4   " style="color: #ff0b87;">Welcome To Pearl Fertility And IVF</h2>
          ...
          <div class="main-btn-wrap">
                        <a href="about-us.php" class="main-btn btn"  style="    margin-top: -10px;
    margin-bottom: 20px;">Read More</a>
                      </div>
        </div>
      </div>
    </div>
    <div class="row">
      <div class="col-lg-12">
        <div class="flexible-slider wow fadeInUp" data-items="4" data-items-992="2" data-items-768="1" data-arrows="true" data-dots="true">
          <div class="slider-items ">
            ...
            <div class="item">
              <div class="department-box-1 bg-blue ">
                ...
                <h4 class="heading font-bold mt-10 mb-10">Infertility Work UP</h4>
                <!-- <p class="heading h6 font-semi-bold text-primary">
                    Research &amp; Lab
                  </p>
                  <p class="mb-20 text-lh-7 text-muted">
            ...
            <div class="item">
              <div class="department-box-1 bg-pink">
                ...
                <h4 class="heading font-bold mt-10 mb-10">Freezing Service</h4>
  ...
  <!----------------------- Banner-part------A.A  -->
  <div class="pt-50 pb-50 mt-80" style="
    ...
    <div class="container justify-content-end">
      <div class="row banner-row align-items-center ">
        ...
        <h3 class="heading font-bold text-lh-4 pb-4 wow fadeInLeft" style="color:black;">We Offer Wide Range Of Services At Pearl Fertility And IVF</h2>

          <p class=" h5   d-flex align-items-center">
            <i class="ion-medal-outline mr-20" style="font-weight:300; font-size:35px;"></i>
            With You at Every Step.
          </p>
          <p class=" h5  d-flex align-items-center mb-20">
            <i class="mw-baby mr-20" style="font-weight:800; font-size:35px;"></i>
            Plan your family with bright future
          </p>
          <p class=" h5 d-flex align-items-center mb-20">
            <i class="mw-care mr-20" style="font-weight:800; font-size:35px;"></i>
            Providing care for future family
          </p>
          <a href="book-appointment.php" class="btn btn-primary btn-lg ml-40">Fix Appointment</a>
    ...
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="heading-block wow fadeInLeft">
          <h2 class="heading font-bold text-lh-4 text-primary"> About Pearl Fertility</h2>
          <h4 class="heading font-bold text-lh-4 pt-4 pb-4 ">What You Need To Know About Clinic</h4>
        </div>
      </div>
    </div>
  </div>

  <div class="pt-50  bg-light" style="background-image:url('_images/6.png'); background-size: cover; background-position: center center">
    <div class="container">
      <div class="row justify-content-center">
        <div class="col-lg-8 text-center wow fadeInUp">
          ...
          <h3 class="heading font-bold mt-20 mb-20">"Accessible, <span class="text-primary">Compassionate Care, </span></h3>
          <h3 class="font-bold  "><span class="text-primary">Anytime, </span>Anywhere.</h3>
          <p class="h5 mb-40">We offer confidential, non-judgmental reproductive health care for people of any gender, age & nationality.</p>
  ...
  <div class="container mt-50">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="heading-block">
          <h2 class="heading font-bold pb-4 wow fadeInLeft">Testimonial Notes</h2>
          <!-- <p class="sub-heading">
    ...
    <div class="col-12 swiper-container swiper-container-nobe" style="background-color:red">
    ...
    <div class="row align-items-center">
      <div class="col-lg-6 col-12 pl-lg-30 mt-20">
        <div id="a2" class="accordion-2 wow fadeInLeft" role="tablist">
          <div class="accordion-item">
          <h3 class="heading font-bold text-lh-4 text-primary pb-4 wow fadeInLeft"> Frequently Asked Questions</h3>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="section-title-wrap text-center wow fadeInLeft">
            <!--Section Title-->
            <div class="heading-block">
              <h2 class="heading font-bold text-lh-4 text-primary pb-4 wow fadeInLeft">Find Useful Information</h2>
      ...
      <div class="row wow fadeInUp" style="color: white;">
          ...
          <div class="our-process-section__work-items">
            ...
            <div class="work-tiems-inner">
              <div class="padding-bottom-20">
                <h5 class="items-title">Infertility & Evaluation
                </h5>
              </div>
              <p>
                We give uncommon consideration to the underlying workup for a infertile couple as it permits them to choose the correct sort of fertility treatment dependent on the underlying reports.
        ...
        <div class="col-lg-4 col-md-6">
          ...
          <div class="our-process-section__work-items">
            ...
            <div class="work-tiems-inner">
              <div class="padding-bottom-20">
                <h5 class="items-title">Fertility Advice
                </h5>
              </div>
              <p>
                Discover the factors influencing fertility, learn about testing procedures, explore treatment choices like IVF and IUI, and find lifestyle tips for optimizing your reproductive health.
  ...
  <div class="container mt-80">
    <div class="row justify-content-center">
      <div class="col-lg-8">
        <div class="heading-block">
          <h3 class="heading font-bold text-lh-4 text-primary pb-4 wow fadeInLeft">Nutrition And Health Services</h3>
          <!-- <p class="sub-heading">There live the blind texts separated they right at the coast of the Semantics.</p> -->
        </div>
      </div>
    </div>
          ...
          <div class="row">
            <div class="col-md-6">
              <div class="owl-carousel owl-theme" id="gallery-2">
                ...
                <div class="item">
                  <a href="img-gallery/4.png" data-fancybox="gallery">
                    <img src="img-gallery/4.png" alt="Image 1" />
                  </a>
                </div>
                <div class="item">
  ...
  <div class="container mt-80 mb-80">
    <div class="row">
      <div class="col-lg-12">
        <div class="heading-block">
          <h3 class="heading font-bold" style="padding-bottom:24px">Our Blog</h3>
          <!-- <p class="sub-heading">
    ...
    <div class="row">
      <div  class="col-md-4 col-12 home-blog-card">
        ...
        <div class="home-blog-card-content p-20">
          <h2 class="home-blog-card-heading">Exploring the Science Behind IVF: How It Works?</h2>
          <p class="home-blog-card-info">Posted on March 25th, 2024 Do you want to grow your family but can’t conceive? If so, you may wonder...</p>
