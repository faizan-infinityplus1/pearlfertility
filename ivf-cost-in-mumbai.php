...
<body>
    ...
    <div class="page-header"> <!-- Page Header -->
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="heading bold">IVF Cost in Mumbai</h1>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <ul class="breadcrumb">
                            ...
                            <li class="active">IVF Cost in Mumbai</li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            <div class="row  d-flex align-items-start">
                <div class="col-lg-6 col-12 pt-40 pl-40 pr-40 wow fadeInLeft ">
                    <p class="wow h5 fadeInUp">
                    The cost of IVF (In Vitro Fertilization) in Mumbai can vary depending on various factors such as the clinic, the specific procedures involved, any additional treatments or medications needed, and the individual's medical situation. On average, IVF in Mumbai can range from around INR 1,00,000 to INR 2,50,000 per cycle. However, this is a rough estimate and costs can vary widely.  whereas at Pearl Fertility And IVF
